...
function renderBracket() {
    ...
    for (let i = 0; i < count; i++) {
      pairs.push(`
        <div class="bracket-pair flex-1 flex flex-col">
          <div class="flex-1 flex items-center"><div class="bracket-connector-right w-4"></div></div>
          <div class="flex-1 flex items-center"><div class="bracket-connector-right w-4"></div></div>
        </div>
      `);
    }
  ...
  function renderLeftConnectors(count) {
    return `<div class="flex flex-col justify-around">
      ${Array(count).fill(`<div class="flex-1 flex items-center"><div class="bracket-connector-left w-4"></div></div>`).join('')}
    </div>`;
  }
